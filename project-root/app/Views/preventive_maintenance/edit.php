...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted">Instandhaltungsplan bearbeiten</p>
    </div>
    <div>
        <a href="<?= base_url("preventive-maintenance/{$schedule['id']}") ?>" class="btn btn-outline-secondary me-2">
...
<form method="post" action="<?= base_url("preventive-maintenance/{$schedule['id']}") ?>">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="priority" name="priority" required>
                                    ...
                                    <option value="medium" <?= old('priority', $schedule['priority']) == 'medium' ? 'selected' : '' ?>>Mittel</option>
        ...
        <div class="col-lg-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="lead_time_days" name="lead_time_days"
                               value="<?= esc(old('lead_time_days', $schedule['lead_time_days'])) ?>"
                               min="0" max="365">
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="auto_generate_work_orders"
                                   ...
                                   <?= old('auto_generate_work_orders', $schedule['auto_generate_work_orders']) ? 'checked' : '' ?>>
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="is_active">
                                Instandhaltungsplan aktiv
                            </label>
                        </div>
                        <div class="form-text">Deaktivierte Pläne werden nicht ausgeführt</div>
                    </div>
                </div>
            </div>
            ...
            <div class="card mt-3">
                <div class="card-body text-center">
                    ...
                    <a href="<?= base_url("preventive-maintenance/{$schedule['id']}") ?>" class="btn btn-outline-secondary w-100">
